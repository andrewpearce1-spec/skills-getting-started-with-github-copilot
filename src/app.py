...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball practices and competitive games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Soccer training and friendly matches for all skill levels",
    ...
    "Drama Club": {
        "description": "Acting workshops, rehearsals, and stage performances",
        "schedule": "Tuesdays and Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 14,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Debate Team": {
        "description": "Learn debate techniques and compete in academic tournaments",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
